...
def create_binary_mask(center_points, image_shape, radius=20):
...
def convert_annotations(json_folder, image_folder, output_folder):
...
json_folder = 'datasets/RFCP_ORANGE/val/labels'
image_folder = 'datasets/RFCP_ORANGE/val/images'
output_folder = 'datasets/RFCP_ORANGE/val/masks'
superpixel_output_folder = 'datasets/RFCP_ORANGE/val/superpixel'

num_segments = 1000
compactness = 10
superpixel_segmentation(image_folder, superpixel_output_folder, num_segments, compactness)
# Convert annotations to masks
convert_annotations(json_folder, image_folder, output_folder)
