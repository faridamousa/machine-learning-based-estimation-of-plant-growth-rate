...
# Main function
def main():
    superpixel_dir = "datasets/RFCP_ORANGE/train/superpixel/"
    mask_dir = "datasets/RFCP_ORANGE/train/masks/"
    test_images_dir = "datasets/RFCP_ORANGE/val/superpixel/"
    test_mask_dir = "datasets/RFCP_ORANGE/val/masks/"
    original_dir = "datasets/RFCP_ORANGE/val/images/"
    result_folder = "datasets/RFCP_ORANGE/val/"
    # Load training data
