...
# Main function
def main():
    superpixel_dir = "datasets/RFCP/train/superpixel/"
    mask_dir = "datasets/RFCP/train/masks/"
    test_images_dir = "datasets/RFCP/val/superpixel/"
    test_mask_dir = "datasets/RFCP/val/masks/"
    original_dir = "datasets/RFCP/val/images/"
    result_folder = "datasets/RFCP/result_val/"
    # Load training data
