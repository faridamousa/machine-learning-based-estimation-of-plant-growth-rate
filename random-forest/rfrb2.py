...
def segment_plants(superpixel_image_path, original_image_path, classifier):
    ...
    segmented_image[dilated_mask == 0] = (0, 0, 0)  # Set non-plant pixels to black
    segmented_image[dilated_mask == 1] = (255, 255, 255)  # Set plant pixels to white in orange regions
...
# Main function
def main():
    superpixel_dir = "datasets/RFRB_ORANGE/train/superpixel/"
    mask_dir = "datasets/RFRB_ORANGE/train/masks/"
    test_images_dir = "datasets/RFRB_ORANGE/val/superpixel/"
    test_mask_dir = "datasets/RFRB_ORANGE/val/masks/"
    original_dir = "datasets/RFRB_ORANGE/val/images/"
    result_folder = "datasets/RFRB_ORANGE/result_val/"
    # Load training data
