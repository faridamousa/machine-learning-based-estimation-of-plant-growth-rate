...
def convert_annotations(xml_folder, image_folder, output_folder, target_size):
    for xml_file in os.listdir(xml_folder):
        ...
        for obj in root.findall('object'):
            ...
            if name != 'rape':  # Skip if not the desired class
                continue
        ...
        cv2.imwrite(output_path, resized_mask * 255)   # Save as 0 and 255 (black and white)
...
xml_folder = 'datasets/RFRB/val/labels'
image_folder = 'datasets/RFRB/val/images'
output_folder = 'datasets/RFRB/val/masks'
superpixel_output_folder = 'datasets/RFRB/val/superpixel'
...
convert_annotations(xml_folder, image_folder, output_folder, target_size)
